  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0f0d0b;padding:48px 24px;">
    <tr><td align="center">
      <table width="100%" style="max-width:560px;background:#161310;border-radius:12px;border:1px solid #2a2622;padding:48px 40px;">
        <tr><td>
          <p style="margin:0 0 32px;font-size:13px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;color:#f59e0b;">Billy Explains</p>
          ...
          <a href="https://billyexplains.com/guides" style="display:inline-block;background:#f59e0b;color:#0f0d0b;text-decoration:none;padding:14px 28px;border-radius:100px;font-size:14px;font-weight:600;">Read the guides</a>
          <p style="margin:32px 0 0;font-size:13px;color:#a8a097;line-height:1.6;">You're getting this because you purchased at billyexplains.com. <a href="#" style="color:#a8a097;">Unsubscribe</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
